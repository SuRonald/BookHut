...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        query = "INSERT INTO BookDatas VALUES(1, 'The Hobbit', 'J. R. R. Tolkein', 4, 100000, 'https://upload.wikimedia.org/wikipedia/id/b/b3/The_Hobbit-_An_Unexpected_Journey.jpeg', 'BookDesc')";
        sqLiteDatabase.execSQL(query);
        ...
        query = "INSERT INTO BookDatas VALUES(4, 'The Hunger Game', 'Suzanne Collins', 4, 100000, 'https://images-na.ssl-images-amazon.com/images/I/51SwRcAjzhL.jpg', 'BookDesc')";
        sqLiteDatabase.execSQL(query);
        ...
        query = "INSERT INTO BookDatas VALUES(6, 'Harry Potter and the Philosophers Stone', 'J. K. Rowling', 4, 100000, 'https://kbimages1-a.akamaihd.net/93affabc-5161-421e-80d5-4477a07b8cee/1200/1200/False/harry-potter-and-the-philosopher-s-stone-3.jpg', 'BookDesc')";
        sqLiteDatabase.execSQL(query);
